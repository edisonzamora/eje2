...
public class Codigo implements org.apache.axis2.databinding.ADBBean {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":codigo", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "codigo", xmlWriter);
    ...
    public static class Factory {
         ...
         */
        public static Codigo parse(javax.xml.stream.XMLStreamReader reader)
            throws java.lang.Exception {
            Codigo object = new Codigo();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"codigo".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (Codigo) com.elelemtos.libro2.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
